 ...
 * @author Eduardo
 */
public class GUIACT extends javax.swing.JFrame {
    ...
    TConfTorneo tconft;
    /**
     * Creates new form GUIACT
     */
    public GUIACT() {
        conft = new ConfTorneo();
        tconft = new TConfTorneo();
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Nombre de torneo:");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtNombreTorneo, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(130, 130, 130)
    ...
    private void btnCrearTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCrearTActionPerformed
        ...
        String descripcion = "Ingresa descripción sobre el torneo a realizar.";
        tconft.ingresarConfTorneo(new ConfTorneo(txtNombreTorneo.getText(),descripcion));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUIACT.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
